...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-white shadow-premium hover:bg-primary-light hover:shadow-premium-lg active:scale-[0.98]",
        secondary:
          "bg-secondary text-primary shadow-premium hover:bg-secondary-light hover:shadow-premium-lg active:scale-[0.98]",
        outline:
          "border-2 border-primary/30 bg-transparent text-primary hover:bg-primary hover:text-white active:scale-[0.98]",
        ghost:
          "text-primary hover:bg-accent hover:text-primary",
        accent:
          "bg-accent text-primary border border-primary/10 hover:bg-accent/80 active:scale-[0.98]",
        whatsapp:
